  ...
  const steps = [
    {
      ...
      icon: "🔍",
      details: "सफाई, प्लंबिंग, इलेक्ट्रिकल वर्क, उपकरण मरम्मत, और अन्य श्रेणियों को ब्राउज़ करें। प्रत्येक सेवा विस्तृत विवरण, मूल्य निर्धारण, और प्रदाता रेटिंग के साथ आती है।"
    },
    {
      id: 2,
      title: "प्रदाता चुनें",
      description: "रेटिंग, समीक्षा, और उपलब्धता के आधार पर सत्यापित पेशेवरों में से चुनें।",
      icon: "👥",
      details: "अनुभव, प्रमाणपत्र, ग्राहक समीक्षा, और रियल-टाइम उपलब्धता सहित सेवा प्रदाताओं की विस्तृत प्रोफाइल देखें। आसानी से कीमतों और सेवाओं की तुलना करें।"
    },
    {
      id: 3,
      ...
      icon: "📅",
      details: "एक सुविधाजनक समय स्लॉट चुनें जो आपके लिए काम करे। हमारा स्मार्ट शेड्यूलिंग सिस्टम आपके और सेवा प्रदाता दोनों के लिए इष्टतम समय सुनिश्चित करता है।"
    },
    {
      id: 4,
      title: "सेवा वितरण",
      description: "रियल-टाइम ट्रैकिंग और अपडेट के साथ अपने दरवाजे पर पेशेवर सेवा का आनंद लें।",
      icon: "🏠",
      details: "अपने सेवा प्रदाता के आगमन को रियल-टाइम में ट्रैक करें। सेवा प्रक्रिया के दौरान अपडेट प्राप्त करें और हमारे प्लेटफॉर्म के माध्यम से सीधे संवाद करें।"
    },
    {
      id: 5,
      ...
      icon: "⭐",
      details: "कई भुगतान विकल्पों के माध्यम से सुरक्षित रूप से भुगतान करें। अन्य ग्राहकों की मदद करने और हमारी सेवा गुणवत्ता में सुधार के लिए अपने अनुभव को रेट और समीक्षा करें।"
    }
  ];
  ...
  const features = [
    {
      ...
      description: "सभी सेवा प्रदाता पूरी तरह से बैकग्राउंड चेक और कौशल सत्यापन से गुजरते हैं",
      icon: "✅"
    },
    {
    ...
    {
      title: "लचीला शेड्यूलिंग",
      description: "समान दिन और आपातकालीन सेवा विकल्पों के साथ अपनी सुविधा के अनुसार सेवाएं बुक करें",
      icon: "⏰"
    }
  ];
    ...
    <div className={styles.howItWorksContainer}>
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>
            सभी घरेलू सेवाओं के लिए आपका विश्वसनीय साझीदार - सरल, विश्वसनीय, और पेशेवर
          </p>
      ...
      <section className={styles.stepsSection}>
        <div className={styles.container}>
          <h2 className={styles.sectionTitle}>शुरू करने के लिए सरल चरण</h2>
